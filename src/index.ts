...
import { BN, srlp } from 'sophonjs-util'
import Common from 'sophonjs-common'
...
export default class Blockchain {
  ...
  constructor(opts: BlockchainOptions = {}) {
    ...
    this.sofash = this.validate ? new Sofash(this.db) : null
    this._heads = {}
    this._genesis = null
  ...
  _putBlockOrHeader(item: any, cb: any, isGenesis?: boolean) {
    ...
    function verifyPOW(next: any) {
      ...
      self.sofash.verifyPOW(block, (valid: boolean) => {
   ...
   * @param cb - The callback. It is given two parameters `err` and the found `block` (an instance of https://octonion.institute/susy-js/sophonjs-block) if any.
   */
